...
def run(
    *,
    ...
    recent_articles = filter_relevant_articles(
        apply_source_context_entities(recent_articles_by_link.values(), effective_sources),
        effective_sources,
    )
    quality_articles = filter_relevant_articles(
        apply_source_context_entities(quality_articles_by_link.values(), effective_sources),
        effective_sources,
    )
